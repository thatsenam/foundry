                ...
                <div class="min-h-screen h-full flex flex-col ">
                    ...
                    <div class="px-4 py-8 m-auto">
                        <div class="max-w-md m-auto">
                            ...
                            <h1 class="text-3xl text-slate-800 font-bold mb-6">Set up your Community ✨</h1>
                            <!-- Form -->
                            <form>
                                <div class="space-y-3 mb-8">
                                    <label class="relative block cursor-pointer">
                                        <input value="slack" type="radio" name="radio-buttons" class="peer sr-only"
                                               v-model="community_style"
                                               checked/>
                                        <div
                                            ...
                                            <span>I want it to look like Slack - Chat style</span>
                                        </div>
                                        <div
                                    ...
                                    <label class="relative block cursor-pointer">
                                        <input value="facebook" v-model="community_style" type="radio"
                                        ...
                                        <div
                                            ...
                                            <span>I want it to look and feel like Facebook - Feed style</span>
                                        </div>
                                        <div
                                            class="absolute inset-0 border-2 border-transparent peer-checked:border-indigo-400 rounded pointer-events-none"
                                            aria-hidden="true"></div>
                                    ...
                                    <label class="relative block cursor-pointer">
                                        ...
                                        <input value="reddit" v-model="community_style" type="radio"
                                               name="radio-buttons" class="peer sr-only"/>
                                        <div
                                            class="flex items-center bg-white text-sm font-medium text-slate-800 p-4 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                                            <svg class="w-6 h-6 shrink-0 fill-current mr-4" viewBox="0 0 24 24">
                                            ...
                                            <span>I want it too look more like Reddit - Forum style</span>
                                        </div>
                                        <div
                                            class="absolute inset-0 border-2 border-transparent peer-checked:border-indigo-400 rounded pointer-events-none"
                                            aria-hidden="true">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div @click="skipCommunity"
                                         class="btn bg-slate-600 hover:bg-slate-800 text-white ml-auto cursor-pointer mr-4">
                                        Skip (Don’t Build a Community Now) →
                                    </div>
                                    <div @click="submitOnboarding"
                                         class="btn bg-indigo-500  hover:bg-indigo-600 text-white ml-auto  cursor-pointer">
                                        Next Step →
                                    </div>
                                </div>
                            </form>
            ...
            <div class="login-footer absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div class="flex text-da ">
                    ...
                    <div class="copyright text-sm">
                        <div class="m-0 text-dim">All rights eserved. Hexigon AI suite of products.</div>
                        <div><a class="text-dim" href="https://www.hexigon.ai/" target="_blank">View Hexigon.ai</a>
                            <span
                                class="mx-2"> • </span> <a class="text-dim"
                                                           href="https://www.hexigon.ai/legal/terms-and-conditions"
                                                           target="_blank">Terms & Conditions</a></div>
                    </div>
                </div>
...
<script>
    ...
    export default {
        data() {
            return {
                community_style: 'slack',
            }
        },

        methods: {
            ...mapMutations(['UPDATE_ONBOARDING01']),

            submitOnboarding() {
                this.$store.commit('auth/UPDATE_ONBOARDING01', {community_style: this.community_style});
                this.$router.push('/onboarding-02')
            }, skipCommunity() {
                this.$store.commit('auth/SKIP_ONBOARDING');
                this.$router.push('/onboarding-03')
