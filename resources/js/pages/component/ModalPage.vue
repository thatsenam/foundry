                ...
                <div class="flex flex-wrap items-center -m-1.5">
                    ...
                    <ModalBasic id="basic-modal" :modalOpen="basicModalOpen" @close-modal="basicModalOpen = false" title="Basic Modal">
                      ...
                      <div class="px-5 py-4">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600" @click.stop="basicModalOpen = false">Close</button>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBasic id="scrollbar-modal" :modalOpen="scrollbarModalOpen" @close-modal="scrollbarModalOpen = false" title="Modal w/ Scroll Bar">
                      ...
                      <div class="sticky bottom-0 px-5 py-4 bg-white border-t border-slate-200">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600" @click.stop="scrollbarModalOpen = false">Close</button>
                          <button class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white">I Understand</button>
                        </div>
                      </div>
                    </ModalBasic>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalCookies id="cookies-modal" :modalOpen="cookiesModalOpen" @close-modal="cookiesModalOpen = false" title="We use cookies 🍪">
                      ...
                      <!-- Modal footer -->
                      <div class="flex flex-wrap justify-end space-x-2">
                        <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600" @click.stop="cookiesModalOpen = false">Decline</button>
                    ...
                    <ModalBlank id="success-modal" :modalOpen="successModalOpen" @close-modal="successModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div>
                          ...
                          <!-- Modal footer -->
                          <div class="flex flex-wrap justify-end space-x-2">
                            <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600" @click.stop="successModalOpen = false">Cancel</button>
                    ...
                    <ModalBlank id="info-modal" :modalOpen="infoModalOpen" @close-modal="infoModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div>
                          ...
                          <!-- Modal footer -->
                          <div class="flex flex-wrap justify-end space-x-2">
                            <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600" @click.stop="infoModalOpen = false">Cancel</button>
                ...
                <div class="flex flex-wrap items-center -m-1.5">
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBasic id="feedback-modal" :modalOpen="feedbackModalOpen" @close-modal="feedbackModalOpen = false" title="Send Feedback">
                      ...
                      <div class="px-5 py-4 border-t border-slate-200">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600" @click.stop="feedbackModalOpen = false">Cancel</button>
                  ...
                  <div class="m-1.5">
                    ...
                    <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white"
                            aria-controls="newsletter-modal" @click.stop="newsletterModalOpen = true">Newsletter
                    </button>
                    ...
                    <ModalAction id="announcement-modal" :modalOpen="announcementModalOpen" @close-modal="announcementModalOpen = false">
                      ...
                      <div class="text-center">
                        ...
                        <div class="space-y-3">
                          ...
                          <div>
                            <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600" href="#0" @click.prevent="announcementModalOpen = false">Not Now!</a>
                          </div>
                        </div>
                      </div>
                    </ModalAction>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalAction id="integration-modal" :modalOpen="integrationModalOpen" @close-modal="integrationModalOpen = false">
                      ...
                      <!-- Modal footer -->
                      <div class="flex flex-wrap justify-end space-x-2">
                        <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600" @click.stop="integrationModalOpen = false">Cancel</button>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBasic id="feedback-modal" :modalOpen="planModalOpen" @close-modal="planModalOpen = false" title="Change your Plan">
                      ...
                      <div class="px-5 py-4">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600" @click.stop="planModalOpen = false">Cancel</button>
