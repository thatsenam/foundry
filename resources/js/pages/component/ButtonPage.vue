    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden bg-white">
      ...
      <main>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <!-- Page header -->
          <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Button ✨</h1>
          </div>
          ...
          <div class="border-t border-slate-200">
            ...
            <div class="space-y-8 mt-8">
              ...
              <!-- Appearances -->
              <div>
                <h2 class="text-2xl text-slate-800 font-bold mb-6">Appearances</h2>
                <div class="flex flex-wrap items-center -m-1.5">
                  ...
                  <div class="m-1.5">
                    <!-- Start -->
                    <button class="btn border-slate-200 hover:border-slate-300 text-slate-600">Tertiary</button>
                    <!-- End -->
                  </div>
                  <div class="m-1.5">
                    <!-- Start -->
                    <button class="btn bg-rose-500 hover:bg-rose-600 text-white">Danger</button>
                    <!-- End -->
                  </div>
                  <div class="m-1.5">
                    <!-- Start -->
                    <button class="btn border-slate-200 hover:border-slate-300 text-rose-500">Danger</button>
                    <!-- End -->
                  </div>
                  <div class="m-1.5">
                    <!-- Start -->
                    <button class="btn bg-emerald-500 hover:bg-emerald-600 text-white">Success</button>
                    <!-- End -->
                  </div>
                  <div class="m-1.5">
                    <!-- Start -->
                    <button class="btn border-slate-200 hover:border-slate-300 text-emerald-500">Success</button>
                    <!-- End -->
                  </div>
                </div>
              </div>
              ...
              <!-- States -->
              <div>
                <h2 class="text-2xl text-slate-800 font-bold mb-6">States</h2>
                <div class="flex flex-wrap items-center -m-1.5">
                  <div class="m-1.5">
                    <!-- Start -->
                    <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white disabled:border-slate-200 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed shadow-none" disabled>Disabled</button>
                    <!-- End -->
                  </div>
                  <div class="m-1.5">
                    <!-- Start -->
              ...
              <!-- Sizes -->
              <div>
                <h2 class="text-2xl text-slate-800 font-bold mb-6">Sizes</h2>
                <div class="flex flex-wrap items-center -m-1.5">
                  <div class="m-1.5">
                    <!-- Start -->
              ...
              <div>
                <h2 class="text-2xl text-slate-800 font-bold mb-6">Buttons with an Icon</h2>
                <div class="flex flex-wrap items-center -m-1.5">
                  <div class="m-1.5">
                    <!-- Start -->
              ...
              <!-- Icon Buttons -->
              <div>
                <h2 class="text-2xl text-slate-800 font-bold mb-6">Icon Buttons</h2>
                <div class="flex flex-wrap items-center -m-1.5">
                  <div class="m-1.5">
                    <!-- Start -->
              ...
              <!-- Button Groups -->
              <div>
                <h2 class="text-2xl text-slate-800 font-bold mb-6">Button Groups</h2>
                <div class="flex flex-wrap items-center -m-1.5">
                  <div class="m-1.5">
                    <!-- Start -->
                    <div class="flex flex-wrap -space-x-px">
                      <button class="btn bg-indigo-600 text-white rounded-none border-l-indigo-400 first:rounded-l last:rounded-r first:border-r-transparent">Weekly</button>
                  ...
                  <div class="m-1.5">
                    <!-- Start -->
                    <div class="flex flex-wrap -space-x-px">
                      <button class="btn bg-slate-50 border-slate-200 hover:bg-slate-50 text-indigo-500 rounded-none first:rounded-l last:rounded-r">Weekly</button>
                      <button class="btn bg-white border-slate-200 hover:bg-slate-50 text-slate-600 rounded-none first:rounded-l last:rounded-r">Monthly</button>
                      <button class="btn bg-white border-slate-200 hover:bg-slate-50 text-slate-600 rounded-none first:rounded-l last:rounded-r">Yearly</button>
                    </div>
                    <!-- End -->
                  </div>
                </div>
