                            ...
                            <form>
                                <div class="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
                                    <label class="flex-1 relative block cursor-pointer">
                                        <input type="radio" name="radio-buttons" value="individual" class="peer sr-only" v-model="account_type" checked/>
                                        <div
                                            ...
                                            <div class="font-medium text-slate-800 mb-1">I am an Individual</div>
                                            <div class="text-sm">This will be a free community that will grow
                                                organically
                                            </div>
                                        </div>
                                        <div
                                    ...
                                    <label class="flex-1 relative block cursor-pointer">
                                        <input type="radio" value="organization" v-model="account_type" name="radio-buttons" class="peer sr-only"/>
                                        <div
                                            class="h-full text-center bg-white px-4 py-6 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                                            <svg class="inline-flex w-10 h-10 shrink-0 fill-current mb-2"
                                                 viewBox="0 0 40 40">
                                            ...
                                            <div class="font-medium text-slate-800 mb-1">I belong to an Organization
                                            </div>
                                            <div class="text-sm">This community is for my organization I belong too.
                                            </div>
                                        </div>
                                        <div
                                            class="absolute inset-0 border-2 border-transparent peer-checked:border-indigo-400 rounded pointer-events-none"
                                ...
                                <div class="flex items-center justify-between space-x-6 mb-8">
                                    <div>
                                        <div class="font-medium text-slate-800 text-sm mb-1">💸 Do you plan on
                                            monetizing your community?
                                        </div>
                                        <div class="text-xs">You don’t have to answer now, this will just let us know in
                                            the future what your growth intentions are.
                                        </div>
                                    </div>
                                    <div class="flex items-center">
                                        <div class="form-switch">
                                            <input type="checkbox" v-model="monetize_community" id="switch" class="sr-only" checked/>
...
<script>
    ...
    export default {
        ...
        methods:{
            submitOnboarding(){
                this.$store.commit('auth/UPDATE_ONBOARDING02',{'account_type':this.account_type,'community': this.monetize_community})
