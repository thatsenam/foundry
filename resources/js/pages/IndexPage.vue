                ...
                <section class="relative">
                    <div class="max-w-6xl mx-auto px-4 sm:px-6">
                        <div class="pt-32 md:pt-40 ">
                            <div class="text-start pb-12 md:pb-16"><h1
                                class="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4 aos-init aos-animate"
                                data-aos="zoom-y-out">
                                <span
                                    class="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">Get started on the Foundry</span>
                            </h1>
                                <div class="max-w-3xl"><p
                                    class="text-xl text-white mb-8 aos-init aos-animate" data-aos="zoom-y-out"
                                    data-aos-delay="150">Community of Chat, a Community of Creatives. Embed yours</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="relative text-white pb-12">
                    <div class="max-w-6xl mx-auto px-4 sm:px-6">
                        <div class=" p-4 bg-black">
                            ...
                            <div v-for="community in communities" class="p-4" style="background: #20252D;">
                                <div class="flex items-center justify-between ">
                                    <div class="flex text-white">
                                        <img class="rounded" :src="community.avatar_url" alt="" width="72" height="72">
                                        <div class="flex flex-col ml-4 ">
                                            <span class="text-2xl text-white">{{ community.name }}</span>
                                            <p>{{ community.description }}</p>
                                            <div class="flex text-white-50 items-center">
                                                <div class="fork-logo">
                                                ...
                                                <span class="ml-2 text-white-50 mr-4">{{ community.community_user_count }}</span>

                                                <div class="star-logo ml-4 mr-4" v-if="community.rate">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M10 5.93388L8 0L6 5.93388H0L4.89 9.88843L2.968 16L8 12.2231L13.032 16L11.11
                                                             9.88843L16 5.93388H10Z"
                                                            fill="#F59E0B"/>
                                                    </svg>
                                                ...
                                                <span class="ml-2 "
                                                      style="color: #F59E0B">{{ community.post_count }}</span>
                                    ...
                                    <div class="flex">
                                        ...
                                        <router-link v-show="community.join_community"
                                                     :to="{name:'dashboard',params:{id:community.id}}"
                                                     class="ant-btn ant-btn-primary"
                                                     type="primary">Launch
                                        </router-link>

                                        <a-button type="default" class="ml-4" v-show="community.join_community"><span
                                            class="text-blue-300">✓ </span>Joined
                                        </a-button>

                                        <span v-show="!community.join_community" @click="joinCommunity(community.id)"
                                              class="ant-btn ant-btn-primary"
                                              type="primary">Join ->
                                        </span>
                ...
                <section>
                    <div class="max-w-6xl mx-auto px-4 sm:px-6">
                        <div class="pb-12 md:pb-20">
                            <div
                                class="relative flex bg-gray-900 rounded  shadow-2xl overflow-hidden aos-init aos-animate items-center"
                                data-aos="zoom-y-out" style="background: #04010C;">

                                <div
                                    class="relative flex flex-grow flex-col lg:flex-row justify-between items-center p-4 ">
                                    <div class="text-center lg:text-left lg:max-w-xl">
                                        <h3 class="h4 text-white mb-2">Get ready for the community driven metaverse.
                                            <br> We are coming for you.</h3>
                                        <p class="text-gray-300  text-sm">Get custom Communities & Verses (soon) built
                                            for your startup or enterprise, today. Contact hello@hexigon.ai today for
                                            quotes.</p>
                                    </div>
                                </div>
                                <div class="">
                                    <img src="images/metaverse.png" alt="" width="100%" height="100%">
                                </div>
    ...
    export default {
        ...
        data() {
            return {
                communities: [
                    {
                        name: 'BrandWeld',
                        logo: 'images/brand-weld-logo.png',
                        description: 'This is everything no=code and Design',
                        forked: '4K+',
                        rate: true,
                        rate_count: '4.5',
                        joined: true
        ...
        computed: {
            communities() {
                ...
                if (_community.length > 10) {
                    _community = _community.splice(0, 9)
                }
                return _community;
            }
        },
...
<style scoped>
    @import "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;700;800;900&display=fallback";
    ...
    *, :before, :after {
        ...
        --tw-ring-offset-width: 0px;
        --tw-ring-offset-color: #fff;
        --tw-ring-color: rgb(51 140 245 / .5);
    ...
    .from-gray-100 {
        ...
        --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to, rgb(251 251 251 / 0))
    }

    .from-blue-500 {
        --tw-gradient-from: #338CF5;
        --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to, rgb(51 140 245 / 0))
    }
    ...
    .shadow-md {
        --tw-shadow: 0 4px 6px -1px rgba(0, 0, 0, .04), 0 2px 4px -1px rgba(0, 0, 0, .03);
    ...
    .shadow-xl {
        --tw-shadow: 0 20px 25px -5px rgba(0, 0, 0, .12), 0 10px 10px -5px rgba(0, 0, 0, .02);
    ...
    .shadow-2xl {
        --tw-shadow: 0 25px 50px -12px rgba(0, 0, 0, .15);
