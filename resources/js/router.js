...
import CommunityBrowse from './pages/CommunityBrowse.vue'
...
import Metaverse from "./components/landing/Metaverse";
...
import CommunityBookmarks from "./pages/community/CommunityBookmarks";
import CommunityProfile from "./pages/community/CommunityProfile";
import CommunityPost from "./pages/community/CommunityPost";
import Following from "./pages/community/Following";
import ForumPostContainer from "./pages/community/ForumPostContainer";
...
const router = createRouter({
    ...
    routes: [
        {
            path: '/community_browse',
            component: CommunityBrowse,
            name: 'community_browse',
            meta: {
                middleware: "guest"
            },
