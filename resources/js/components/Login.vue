                            ...
                            <div class="login-content">
                                ...
                                <form>
                                    <div class="space-y-4">
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="email">Email
                                                Address</label>
                                            <input id="email" v-model="auth.email" class="form-input w-full"
                                                   type="email"/>
                                            <span v-for="error of v$.auth.email.$errors" :key="error.$uid">
                                        ...
                                        <div>
                                            ...
                                            <input id="password" v-model="auth.password" class="form-input w-full"
                                                   type="password" autoComplete="on"/>
                                            <span v-for="error of v$.auth.password.$errors" :key="error.$uid">
                                                <div class="text-xs mt-1 text-rose-500">{{ error.$message }}</div>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-between mt-6">
                                        <div class="mr-1">
                                            <router-link class="text-sm underline hover:no-underline"
                                                         to="/reset-password">
                                                Forgot Password?
                                            </router-link>
                                        </div>
        ...
        <div class="login-footer absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div class="flex text-da ">
                ...
                <div class="copyright text-sm">
                    ...
                    <p><a class="text-dim" href="https://www.hexigon.ai/" target="_blank">View Hexigon.ai</a>
                        <span
    ...
    export default {
            ...
            async login() {
                ...
                await axios.post('/login', this.auth).then(({data}) => {
                    this.signIn().then((response) => {
                        if (this.user.on_boarding === 0) {
                            this.$router.push({name: 'onboarding-01'})
                        } else {
                            this.$router.push({name: 'community_browse'})
                    ...
                    notification['error']({
                        ...
                        description: 'Email or password are invalid. Please try again'
                    });
                }).finally(() => {
        ...
        mounted() {
            ...
            if (this.authenticated) {
                // if (this.user.current_community_id){
                if (false) {
                    router.push({name: 'dashboard', params: {id: this.user.current_community_id}})
