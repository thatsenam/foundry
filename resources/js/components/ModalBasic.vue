<template>
  ...
  >
    <div v-show="modalOpen" class="fixed inset-0 bg-slate-900 bg-opacity-30 z-50 transition-opacity" aria-hidden="true" style="z-index: 99999999"></div>
  </transition>
  <!-- Modal dialog -->
  <transition
  ...
  >
    <div v-show="modalOpen" :id="id" class="fixed inset-0 z-50 overflow-hidden flex items-center  justify-center transform px-4 sm:px-6" role="dialog" aria-modal="true" style="z-index: 99999999">
