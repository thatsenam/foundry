                ...
                <section class="bg-white border-b py-8">
                    <div class="container max-w-5xl mx-auto m-8">
                        <h1 class="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4 aos-init aos-animate">
                            Connection is evolving and so are we.</h1>
                        ...
                        <div class="flex items-center justify-between mt-20">
                            <div class="mr-4">
                                <h3 class="h3 text-gray-800 font-bold leading-none mb-3">The metaverse will be
                                    social</h3>
                                <p class="text-gray-600 ">3D spaces in the metaverse will let you socialize, learn,
                                    collaborate and play in ways that go beyond what we can imagine. Listen to podcast
                                    share our vision for bringing the metaverse to life together.
                                </p>

                            </div>
                            <div class="">
                                <img class="rounded"
                                     src="https://media.istockphoto.com/photos/man-wearing-vr-glasses-picture-id1351720122?k=20&m=1351720122&s=612x612&w=0&h=L5ZWMXeEl93ri1Q6Nnp7mJixIMlmiZ5YZJ9QoiEwfzw="
                                     alt="" width="100%"
                                     style="min-width: 500px;max-width: 500px;max-height: 333px;min-height: 333px">
                            </div>
                        </div>
                        <div class="flex items-center justify-between mt-20 flex-col-reverse">
                            <div class="">

                                <img class="rounded"
                                     src="https://www.gmw3.com/wp-content/uploads/2022/01/shutterstock_2093095552-1920x1024.jpg"
                                     alt="" width="100%"
                                     style="min-width: 500px;max-width: 500px;max-height: 333px;min-height: 333px">

                            </div>
                            <div class="ml-4">
                                <h3 class="h3 text-gray-800 text-right font-bold leading-none mb-3">Discover all you can
                                    do with virtual reality and augmented reality
                                </h3>
                                <p class="text-gray-600 text-right">In futurism and science fiction, the metaverse is a
                                    hypothetical iteration of the Internet as a single, universal and immersive virtual
                                    world that is facilitated by the use of virtual reality and augmented reality
                                    headsets. In colloquial use, a metaverse is a network of 3D virtual worlds focused
