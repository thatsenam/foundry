<template>
    <header class="fixed w-full z-30 md:bg-opacity-90 transition duration-300 ease-in-out false"
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                <nav class="flex flex-grow items-center justify-between">
                    <ul class="flex text-white ">
                        <li>
                            <router-link class="text-white " :to="{name:'change-log'}">Changelog</router-link>
                        </li>
                        <li class="mx-4">
                            <router-link :to="{name:'metaverse'}" class="text-white">Metaverse</router-link>
                        </li>
                        <li>
                            <router-link :to="{name:'resources'}" class="text-white">Resources</router-link>
                        </li>
                    </ul>
                    <router-link class="logo hover:text-indigo-500" :to="{name:'index'}">
                        <div class="flex items-center ">
                            ...
                            <div class="brand-title">
                                <h2 class="text-2xl  hover:text-indigo-500 md:text-3xl font-bold mb-1 text-white">
                                    Foundry</h2>
                            </div>
                        </div>
                    ...
                    <ul class="flex items-center m-0">
                        ...
                        <li>
                            <router-link class="btn-sm text-white bg-indigo-600 hover:bg-gray-800 ml-3"
                                         to="/login">
                                <span class="text-white" v-if="authenticated">
                                ...
                                <svg class="w-3 h-3 fill-current text-white flex-shrink-0 ml-2 -mr-1"
