        ...
        <div class="flex flex-col min-h-screen overflow-hidden">
            ...
            <main style="margin-top: 120px">
                <div class="max-w-6xl mx-auto px-4 sm:px-6">
                    <div style="background: #1E293B" class="relative flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-8 lg:py-16 bg-indigo-500 overflow-hidden">
                        <!-- Glow -->
                        ...
                        <div class="relative w-full max-w-2xl mx-auto text-center">
                            <div class="mb-5">
                                <h1 class="h2 text-white font-bold">👋 What Can We Help You Find?</h1>
                            </div>
                            <form class="relative">
