<template>
    ...
    <div class="relative flex">
        ...
        <!-- Content -->
        <div class="w-full ">
            <div class=" h-full flex flex h-screen">

                <div class=" flex aligns-center justify-center m-auto ">
                    <div class="login-wrapper px-6" style="width: 399px;height:570px">

                        <div class="login-content">

                            <h1 class="text-3xl text-slate-800 font-bold mb-4">Create your Account</h1>
                            <!-- Form -->
                            <form @submit.prevent="register">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input v-model="user.email" id="email" class="form-input w-full"
                                               type="email"/>
                                    ...
                                    <div>
                                        ...
                                        <input v-model="user.name" id="name" class="form-input w-full"
                                               type="text"
                                        />
                            ...
                            <div class="pt-4 pb-4 mt-4 border-t border-slate-200">
                                <div class="text-sm">
                                    Have an account?
                                    <button class="font-medium text-indigo-500 hover:text-indigo-600"
                                            @click.stop="$emit('blockChange','login')">Sign In
                                    </button>
                                </div>
                            ...
                            <div>
                                <svg width="169" height="38" viewBox="0 0 169 38" fill="none"
                                    ...
                                    <defs>
                                        ...
                                        <linearGradient id="paint2_linear_415_6939" x1="16.9988" y1="8.97713"
                                                        x2="16.9988" y2="30.0674" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#611CFE"/>
                                            <stop offset="1" stop-color="#26D9F1"/>
                                        </linearGradient>
                                        <linearGradient id="paint3_linear_415_6939" x1="-1.91087e-09" y1="-3.33168e-09"
                                                        x2="21.0373" y2="36.6794" gradientUnits="userSpaceOnUse">
                                ...
                                <div class="copyright text-sm">
                                    <div>All rights reserved. Hexigon AI suite of products.
                                    </div>
                                    <p><a href="https://www.hexigon.ai/" target="_blank">View Hexigon.ai</a>
                                        <span
                                            class="mx-2"> • </span> <a
    ...
    methods: {
        ...
        async register() {
            ...
            await axios.post('/register', this.user).then(response => {
                this.$store.dispatch('auth/login').then((data) => {
                    this.$store.dispatch('community/loadCommunities').then(() => {
                        this.$router.go()
                    })
