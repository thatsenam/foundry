                ...
                <div
                    ...
                    <div>
                        ...
                        <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                            <router-link exact :to="{name:'ForumPostContainer'}" key="home"
                            ...
                            <li class="mr-0.5 md:mr-0 md:mb-0.5" v-for="category in categories" :key="category.id">
                                <router-link exact :to="{name : 'ForumPostContainer',query:{category:category.id}}"
                                             :key="category.id"
...
<script>
    ...
    export default {
        name: 'ForumLeftContent',
        components: {ModalBasic, DirectMessages, Channels},
        data() {
            return {
                channels: [],
